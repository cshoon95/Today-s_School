...
public class ChatDAO {
	...
	public ArrayList<ChatDTO> getChatListByID(String fromID, String toID, String chatID) { // 채팅내역을 가져오는 함수
	...
	public ArrayList<ChatDTO> getBox(String userID) { //메시지함
		ArrayList<ChatDTO> chatList = null;
		Connection conn = null;
		PreparedStatement pstmt = null;
		ResultSet rs = null;
	...
	public ArrayList<ChatDTO> getChatListByRecent(String fromID, String toID, int number) { //최근 대화만 가져옴.
		ArrayList<ChatDTO> chatList = null;
		Connection conn = null;
		PreparedStatement pstmt = null;
		ResultSet rs = null;
	...
	public int submit(String fromID, String toID, String chatContent) { // 메시지 전송 함수
		Connection conn = null;
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		String SQL = "INSERT INTO CHAT VALUES (NULL, ?, ?, ?, NOW(), 0)"; // null값을 넣음으로써 chatID값이 자동으로 1씩 증가. NOW()는 현재시간을 나타내는 DB메소드
		try {
			conn = dataSource.getConnection();
			pstmt= conn.prepareStatement(SQL);
			pstmt.setString(1, fromID);
	...
	public int getAllUnreadChat(String userID) { // 읽지 않은 메세지의 개수
		Connection conn = null;
		PreparedStatement pstmt = null;
		ResultSet rs = null;
	...
	public int getUnreadChat(String fromID, String toID) { // 읽지 않은 메세지의 개수
		Connection conn = null;
		PreparedStatement pstmt = null;
		ResultSet rs = null;
