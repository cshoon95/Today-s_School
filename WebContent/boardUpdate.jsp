...
<body>
	<nav class="navbar navbar-default">
		...
		<div class="container">
		<form method="post" action="./boardUpdate" enctype="multipart/form-data"> <!-- 파일 전송은 multipart/form-data -->
			<table class="table table-bordered table-hover" style="text-align: center; border: 1px solid #dddddd">
				...
				<tbody>
					...
					<tr>
						...
						<td><input class="form-control" type="text" maxlength="50" name="boardTitle" placeholder="글 제목을 입력해주세요." value="<%= board.getBoardTitle()%>"></td>	
					</tr>
					<tr>
