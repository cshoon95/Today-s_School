...
<body>
	<%
		...
		if(userID != null) {
			...
			session.setAttribute("messageContent", "이미 로그인이 되어 있습니다.");
	...
	<div class="container">
		<form method="post" action="./userRegister">
			<table class="table table-bordered table-hover" style="text-align: center; border: 1px solid #dddddd">
				<thead>
					<tr>
						<th colspan="3"><h4>Today's School에 오신 것을 환영합니다.</h4></th>
					</tr>
				</thead>
				<tbody>
					<tr>
					...
					<tr>
						...
						<td colspan="2"><input class="form-control" type="text" id="userNickname" name="userNickname" maxlength="20" placeholder="이름을 입력하세요."></td>
					</tr>
					<tr>
