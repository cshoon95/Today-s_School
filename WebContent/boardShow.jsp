...
<%
	...
	BoardDTO board = boardDAO.getBoard(boardID); // 사용자 게시글을 가져옴
	...
	<div class="container">
		<table class="table table-bordered table-hover" style="text-align: center; border: 1px solid #dddddd">
			<thead>
				...
				<tr>
					<td style="backgroud-color: #fafafa; color: #000000; width: 80px;"><h5>제목</h5></td>
					<td colspan="3"><h5><%= board.getBoardTitle() %></h5></td>
				</tr>
				<tr>				
					<td style="backgroud-color: #fafafa; color: #000000; width: 80px;"><h5>작성자</h5></td>
					<td colspan="3"><h5><%= board.getUserID() %></h5></td>
				</tr>
				<tr>				
					<td style="backgroud-color: #fafafa; color: #000000; width: 80px;"><h5>작성날짜</h5></td>
					<td><h5><%= board.getBoardDate() %></h5></td>
					<td style="backgroud-color: #fafafa; color: #000000; width: 80px;"><h5>조회수</h5></td>
					<td><h5><%= board.getBoardHit() + 1%></h5></td>
					<td style="backgroud-color: #fafafa; color: #000000; width: 80px;"><h5>추천수</h5></td>
					<td><h5><%= board.getBoardLikeCount() %></h5></td>					
				</tr>
				...
				<tr>				
					<td style="backgroud-color: #fafafa; color: #000000; width: 80px;"><h5>첨부파일</h5></td>
			...
			<tbody>
				<tr>
					<td colspan="5" style="text-align: right;">
						...
						<span style="color: green;">(추천 : <%= board.getBoardLikeCount() %>)</span>
