...
<head>
	...
	<script type="text/javascript">
		...
		function getInfiniteUnread() {
			setInterval(function() { // 3000, 3초마다 한 번씩 실행
				getUnread();
			}, 3000);
		}
			...
			<table class="table table-bordered table-hover" style="text-align: center; border: 1px solid #dddddd">
				...
				<tbody>
					...
					<tr>
						...
						<td colspan="2"><input class="form-control" type="text" id="userNickname" name="userNickname" maxlength="20" placeholder="이름을 입력하세요." value="<%= user.getUserNickname() %>"></td>
					</tr>
					<tr>
